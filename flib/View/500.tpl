...
<head>
    ...
    <style type="text/css">
        ...
        .error_h1, .error_h1 span { zoom: 1 }
    </style><![endif]-->
</head>
<body id="error_page">
<div class="error-404" style="width: 100%;margin: 150px auto 0;text-align: center;">
    <h1 class="error_h1"><span>500</span></h1>
    <h2 class="title" style="margin: 20px 0 0; font-weight: normal;">Internal Server Error</h2>
    <p style="width: 100%;  margin: 20px auto 0;text-align: center;">服务器内部错误，请稍后访问~</p>
</div>
</body>
</html>