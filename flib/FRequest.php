...
class FRequest
{
    ...
    /**
     * 获得原始的Post数据。
     * @param bool $Compatible 为了方便两种不同post格式的需要
     * @return mixed
     */
    public static function getRawPostData($Compatible = false)
    {
        if ($Compatible) {
            $jsonStr = self::getPostString('json');
        ...
        return file_get_contents("php:/"."/input");//$GLOBALS['HTTP_RAW_POST_DATA'];
    }
