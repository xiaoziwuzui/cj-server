...
class Smarty extends Smarty_Internal_Data {
    ...
    */
     ...
     * 
     * @param string|array $dir | array $dir folder(s) of template sorces
     */
    public function setTemplateDir($dir)
    {
        $this->template_dir = (array)$dir;
        return;
    } 
     ...
     * 
     * @param string|array $dir |array $dir folder(s) of template sources
     */
    public function addTemplateDir($dir)
    {
        $this->template_dir = array_unique(array_merge((array)$this->template_dir, (array)$dir));
        return;
    } 
