...
class FValidator
{
     ...
     * @return bool
     */
    public static function isWechatAccount($string){
        return 0 < preg_match('/[a-zA-Z][a-zA-Z0-9_-]{5,19}/', $string);
    }
     ...
     * @return bool
     */
    public static function isChineseRealName($name){
        if (preg_match('/^[\x80-\xff\w]+$/', $name)) {
            return true;
        } else {
            return false;
        }
