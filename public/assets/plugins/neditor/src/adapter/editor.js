...
;(function () {
        ...
        initEditorUI:function () {
            ...
            function setCount(editor,ui) {
                ...
                if (count > max) {
                    ...
                    msg = msg.replace("{#leave}", max - count).replace("{#count}", count);
                    if(min_word){
                        if(count > min_word){
                            msg += '，内容字数已达到发布要求';
                        }else{
                            msg += '，内容最低要求' + min_word + '字，还差'+(min_word - count) + '个字';
                        }
                    }
    ...
    UE.ui.Editor = function (options) {
        ...
        utils.loadFile(document, {
            href:editor.options.themePath + editor.options.theme + "/css/"+editor.options.theme+".release.css?v=" + editor.options.version,
            tag:"link",
            type:"text/css",
            rel:"stylesheet"
        });
